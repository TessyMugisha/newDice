...
//default constructor
     ...
     */
	public DiceBag(int numberOfDice,int numberOfFaces)throws numberOfDiceRangeExcpetion, numberOfFaceRangeException
	{	
		if(numberOfDice<=0)
		{
			numberOfDiceRangeExcpetion exception=new numberOfDiceRangeExcpetion(" Number of dice must be greater than zero ");
			throw exception;
		}
		else
		{
