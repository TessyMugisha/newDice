...
import PD.DiceBag;
import PD.numberOfDiceRangeExcpetion;
import PD.numberOfFaceRangeException;
...
*/
	public class DiceRollerPanel extends JPanel 
	{
		...
		DiceBag diceBag;
		 ...
		 /**
	     * Constructor for initializing the DiceRollerPanel.
	     */
		...
		private class CountButtonListener implements ActionListener 
		{
			...
			public void actionPerformed(ActionEvent event) 
			{
					...
					catch(numberOfDiceRangeExcpetion exception)
					{
